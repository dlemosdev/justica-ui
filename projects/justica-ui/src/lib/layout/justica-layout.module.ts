...
import {JusticaLayoutConfig, provideJusticaLayout} from './justica-layout.config';
...
export class JusticaLayoutModule {
  static forRoot(configuracao?: JusticaLayoutConfig): ModuleWithProviders<JusticaLayoutModule> {
    return {
